...
(function () {
  const FRANCHISES = [
    ...
    { lines: ["Boston / Milwaukee / Atlanta Braves"], tenures: [
      { stadium: "South End Grounds", start: 1890, end: 1914, visited: false, visitYears: [], visitCount: 0, renames: [] },
      { stadium: "Braves Field", start: 1914, end: 1952, visited: false, visitYears: [], visitCount: 0, renames: [] },
    ...
    { lines: ["Cincinnati Reds"], tenures: [
      ...
      { stadium: "Redland Field", start: 1912, end: 1969, visited: false, visitYears: [], visitCount: 0, renames: [{ year: 1934, name: "Crosley Field" }] },
    ...
    { lines: ["St. Louis Cardinals"], tenures: [
      ...
      { stadium: "Sportsman's Park", start: 1920, end: 1965, visited: false, visitYears: [], visitCount: 0, renames: [{ year: 1953, name: "Busch Stadium" }] },
