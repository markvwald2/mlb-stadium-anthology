/* tropicana-app.jsx — mount the Tropicana Field spread in the shared pan/zoom
   design canvas, with the press-ready single-page print path. "The Service Deck." */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.TropicanaFieldSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#0d1217" : "#E2E4E2";
  ...
  if (params.get("full")) {
    document.body.style.background = "#0d1217";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        subtitle: "The Service Deck \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "tropicana-field-spread",
          label: "Tropicana Field \u2014 roof-service-deck bay spread",
