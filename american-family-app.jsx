/* american-family-app.jsx — mount the American Family Field spread in the
   shared pan/zoom design canvas, with the press-ready single-page print path. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.AmericanFamilySpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#0E1722" : "#ECE4D2";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        subtitle: "The Fan \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "american-family-spread",
          label: "American Family Field \u2014 fan-roof plan spread",
