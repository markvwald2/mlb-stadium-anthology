...
(function () {
  ...
  function Chip(props) {
    const fs = props.size || 13, h = props.h || Math.round(fs * 1.4),
          w = Math.max(props.minW || 0, props.text.length * fs * 0.64 + (props.padX || 8) * 2);
  ...
  function TMobileProtractor(props) {
    ...
    const nums = [0, 30, 60, 90].map((a, i) => {
      ...
      return e("text", { key: "n" + i, x: p[0], y: p[1] + 4, textAnchor: "middle", style: { fontFamily: "'Space Mono',monospace", fontWeight: 700, fontSize: "16px", fill: ink3 } }, a);
    });
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "24 36 312 286", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        ...
        ticks, nums,
        e("text", { x: nlab[0], y: nlab[1] - 15, textAnchor: "middle", style: { fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: "16px", fill: ink, letterSpacing: ".04em" } }, "N"),
        ...
        e(Chip, { x: bc.x, y: bc.y, text: deg + "\u00b0 " + orientation, size: 22, tone: "accent", padX: 7 }),
