...
(function () {
  ...
  function Chip(props) {
    const fs = props.size || 15, w = Math.max(props.minW || 0, props.text.length * fs * 0.62 + (props.padX || 9) * 2), h = props.h || Math.round(fs * 1.35);
  ...
  function GABPProtractor(props) {
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "60 26 300 296", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        ...
        ticks, nums,
        e("text", { x: nlab[0], y: nlab[1] - 9, textAnchor: "middle", style: { fontFamily: "'Saira Condensed',sans-serif", fontWeight: 700, fontSize: "15px", fill: ink, letterSpacing: ".04em" } }, "N"),
        ...
        e(Chip, { x: bc.x, y: bc.y, text: deg + "\u00b0 " + orientation, size: 22, tone: "red", padX: 7 }),
