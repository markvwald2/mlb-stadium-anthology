...
(function () {
  ...
  function Timeline() {
    const nodes = [
      ...
      { y: "1948", cap: "Opened \u00b7 Aug 14", mlb: false },
    ...
    return React.createElement("div", { className: "mh-timeline" },
      React.createElement("div", { className: "tl-head" },
        React.createElement("span", { className: "tl-t" }, "Tenancy"),
        React.createElement("span", { className: "tl-s" }, "A football-first municipal bowl, borrowed by MLB for two seasons")
      ),
        ...
        React.createElement("div", { className: "mh-page mh-right" },
          React.createElement("div", { className: "mh-rp" },
            ...
            React.createElement("div", { className: "mh-section mh-visit" },
              React.createElement(SecHead, { ix: "II", title: "Visit Section", note: D.visit_type }),

              /* visit summary strip */
              React.createElement("div", { className: "mh-vstrip" },
                vsCell("Featured", D.visit_type),
                vsCell("Date", D.first_visit_date),
                vsCell("Day", D.featured_visit_day),
                vsCell("Other Visits", D.other_visits)
              ),
