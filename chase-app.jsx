/* chase-app.jsx — mount the Chase Field spread in a pan/zoom design canvas
   (same wrapper as the other ballpark spreads). */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.ChaseSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#191510" : "#EFE7D6";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        id: "chase",
        title: "Chase Field",
        subtitle: "The Environmental Machine \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "chase-spread",
          label: "Chase Field \u2014 desert climate-machine spread",
