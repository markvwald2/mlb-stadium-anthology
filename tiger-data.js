...
window.TIGER = {
  ...
  stadium_context: [
    ...
    "The site gave the park its power. Tiger Stadium was not set apart in a suburban sports complex or designed as a regional destination object. It was instead embedded in the city, with the field and grandstands pressed into an urban block. That compression produced unusual geometry, overhanging decks, and the famous sense that the building was almost too much structure for its site. Baseball there felt vertical, close, and enclosed by the city around it.",
