...
window.SANDIEGO = {
  ...
  renovations: "Outfield seating expansion in 1984; enlarged and enclosed for football in 1997",
  ...
  stadium_context: [
    ...
    "Petco Park superseded it because the sport had moved in the opposite direction. By 2004, MLB valued downtown specificity, baseball-only geometry, premium spaces, and district-making over the open-ended flexibility of a suburban valley stadium. San Diego Stadium matters because it captures the city's first major-league bargain: use regional infrastructure to get into the national sports map, then later replace that bargain with a park built to make baseball feel local again."
  ]
};
