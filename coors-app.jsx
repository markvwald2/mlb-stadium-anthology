/* coors-app.jsx — mount the Coors Field spread in a pan/zoom design canvas
   (same wrapper as the other ballpark spreads, so the artboard exposes
   the ⋯ → Download PNG / Download HTML menu). */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.CoorsSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#1c1916" : "#EFE7D6";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        id: "coors",
        title: "Coors Field",
        subtitle: "The Mile-High Datum \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "coors-spread",
          label: "Coors Field \u2014 architectural survey spread",
