...
(function () {
  ...
  function Chip(props) {
    const fs = props.size || 14, w = Math.max(props.minW || 0, props.text.length * fs * 0.62 + (props.padX || 8) * 2), h = 21;
  ...
  function BuschProtractor(props) {
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "70 32 300 300", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        ...
        e(Chip, { x: degPos[0], y: degPos[1], text: orientation + " " + deg + "\u00b0", size: 13, tone: "red", padX: 7 }),
