/* new-comiskey-protractor.jsx — New Comiskey Park field-orientation instrument.
   A compact architectural protractor (NOT a generic diamond icon): a half-circle
   scale reads the field-axis bearing off true north and the small bowl is rotated
   to match (SE, 127deg). Arc + ticks + LF/CF/RF chips + the SE / 127 cue.
   Steel-black needle, silver chips, field-green grass — the page's only sustained
   green, kept subordinate. Exposes window.NewComiskeyProtractor. */
(function () {
  const e = React.createElement;

  const ink = "#16150F", steel = "#131210", silver = "#9C9B92", silverHi = "#B9B8AE",
        grass = "#4E6B43", grassHi = "#5E7E54", clay = "#B79268", clayEdge = "#9A774B",
        wallInk = "#2C3A27", concreteHi = "#E5E3DD", rule = "#BDBAB0", ruleStrong = "#9C9B92",
        ink3 = "#7B7A72", ink2 = "#45443D";
  ...
  function NewComiskeyProtractor(props) {
    const deg = (props.degrees != null) ? props.degrees : 127;
    ...
    // protractor scale spanning 0..150 so the SE (127) bearing is enclosed
    const ticks = [];
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "26 36 308 286", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        e("defs", null,
          e("linearGradient", { id: "ncProtGrass", x1: "0", y1: "0", x2: "0", y2: "1" },
            e("stop", { offset: "0", stopColor: grassHi }), e("stop", { offset: "1", stopColor: grass }))
        ),
        e("g", { transform: "rotate(" + deg + " " + C[0] + " " + C[1] + ")" },
          e("path", { d: grassPath, fill: "url(#ncProtGrass)", stroke: wallInk, strokeWidth: 1.5, strokeLinejoin: "round" }),
  ...
  window.NewComiskeyProtractor = NewComiskeyProtractor;
})();
