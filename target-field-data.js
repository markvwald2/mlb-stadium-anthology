...
window.TARGET = {
  ...
  stadium_context: [
    "Target Field replaced the Metrodome by returning Twins baseball to weather, light, and the city. As was the intent, the Metrodome had solved Minnesota\u2019s climate problem through enclosure, temperature control, and multipurpose efficiency. But it gave baseball a football-shaped interior and an artificial sense of place. Target Field chose the harder path: an outdoor ballpark in Minneapolis, exposed to everything a Minnesota winter can bring, fitted onto a constrained downtown site.",
    "The stadium\u2019s location is central to its success. Rather than seek a broad suburban tract or repeat the dome\u2019s interior certainty, the Twins accepted infrastructure pressure on the western edge of downtown as a challenge. Rail lines, highways, parking structures, and warehouse-district edges made the site complicated, but those constraints also gave the park its identity. It feels assembled into the city rather than placed on top of it or beyond its borders.",
    ...
    "Club, seating, and social-space expansion, along with scoreboard, concourse, lighting, and plaza improvements have kept the park evolving within that compact frame. Target Field matters because it shows contemporary ballpark design using constraint as a strength. It did not simply replace a dome with a prettier building. It reversed the Metrodome\u2019s bargain, deciding that exposure, specificity, and city texture were worth the complications they brought."
  ],
