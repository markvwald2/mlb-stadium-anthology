/* pnc-protractor.jsx — PNC Park "Field Plan" graphic, protractor study.
   A PNC-palette copy of the shared protractor diagram so Royals/Coors stay
   untouched. A protractor scale reads the field-axis bearing off true north;
   the simple ballpark is rotated to match. Props: lf, cf, rf, orientation,
   degrees, accent. Exposes window.PNCProtractor. Local data only. */
(function () {
  const e = React.createElement;

  // PNC palette (warm charcoal + Pirates gold + ballpark green)
  const ink = "#1C1B19", black = "#19181A", gold = "#C29433", goldDeep = "#9C772A", goldBright = "#E0A828";
  ...
  function Chip(props) {
    ...
    const fill = tone === "gold" ? gold : paperHi, stk = tone === "gold" ? goldDeep : rule, col = tone === "gold" ? black : ink;
    return e("g", null,
  ...
  function PNCProtractor(props) {
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "62 28 300 290", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        e("defs", null,
          e("linearGradient", { id: "pncProtGrass", x1: "0", y1: "0", x2: "0", y2: "1" },
            e("stop", { offset: "0", stopColor: grassHi }), e("stop", { offset: "1", stopColor: grass }))
        ),
        // field group (rotated)
        e("g", { transform: "rotate(" + deg + " " + C[0] + " " + C[1] + ")" },
          e("path", { d: grassPath, fill: "url(#pncProtGrass)", stroke: wallInk, strokeWidth: 1.6, strokeLinejoin: "round" }),
        ...
        e(Chip, { x: bc.x, y: bc.y, text: deg + "\u00b0", size: 15, tone: "gold", padX: 7 }),
        // distance chips
  ...
  window.PNCProtractor = PNCProtractor;
})();
