/* tiger-app.jsx — mount the Tiger Stadium "Corner Lot" spread in a pan/zoom design canvas. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.TigerSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#161514" : "#ECE6D6";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        id: "tiger",
        title: "Tiger Stadium",
        subtitle: "The Corner Lot \u00b7 Detroit plat \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "tiger-corner-lot",
          label: "The Corner Lot \u2014 Michigan & Trumbull plat sheet",
