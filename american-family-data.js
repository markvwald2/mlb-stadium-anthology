...
window.AMFAM = {
  ...
  stadium_context: [
    ...
    "The site choice was deliberately continuous. Rather than move downtown, Milwaukee kept baseball in the same west-side stadium district, preserving the regional driving patterns and parking-lot rituals that had become part of the club\u2019s identity. That decision makes the park different from the downtown retro-classic wave. Its brick, limestone, steel, glass, and fan-shaped retractable roof gave it a traditional ballpark vocabulary, but its geography remained tied to Milwaukee\u2019s older fairgrounds-adjacent, tailgating-oriented baseball culture.",
