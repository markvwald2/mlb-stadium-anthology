/* rogers-app.jsx — mount the Rogers Centre spread in a pan/zoom design canvas
   (same wrapper as the other ballpark spreads), with the press-ready print branch. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.RogersSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#0f151d" : "#ece4d2";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        id: "rogers",
        title: "Rogers Centre",
        subtitle: "The Retractable Machine \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "rogers-spread",
          label: "Rogers Centre \u2014 retractable-roof retrofit spread",
