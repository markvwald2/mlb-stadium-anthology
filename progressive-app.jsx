/* progressive-app.jsx — mount the Progressive Field spread in a pan/zoom canvas.
   ?print=1&page=left|right[&guides=1] → single press-ready page for vector PDF. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.ProgSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#16181C" : "#E9E7E0";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        subtitle: "The Gateway Frame \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "progressive-spread",
          label: "Downtown Cleveland exposed-steel ballpark \u00b7 retro-classic anthology spread",
