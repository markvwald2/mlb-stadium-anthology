/* nationals-app.jsx — mount the Nationals Park spread in a pan/zoom design canvas. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.NatsSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#14171b" : "#ECE6D9";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        subtitle: "Civic Grid / River Edge \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "nats-spread",
          label: "Navy Yard / Capitol Riverfront civic ballpark",
