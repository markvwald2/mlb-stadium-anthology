/* citizens-protractor.jsx — Citizens Bank Park "Field Dimensions" graphic,
   protractor study. A Citizens-palette copy of the shared protractor diagram so
   the other spreads stay untouched. A protractor scale reads the field-axis
   bearing off true north (N / 9°); the simple ballpark is rotated to match.
   Props: lf, cf, rf, orientation, degrees, accent. Exposes
   window.CitizensProtractor. Local data only. */
(function () {
  const e = React.createElement;

  // Citizens palette (warm charcoal + brick red + ballpark green + Phillies navy)
  const ink = "#211A14", black = "#1A1510", brick = "#8E3B2F", navy = "#1E3A6E";
  const grass = "#5E7350", grassHi = "#6E8460", clay = "#C2A06A", clayEdge = "#A8854A", wallInk = "#52663F";
  const paperHi = "#F4ECDA", rule = "#C3B69C", ruleStrong = "#A89A7C", ink3 = "#8A7E6B", ink2 = "#574B3D";
  ...
  function CitizensProtractor(props) {
    const accent = props.accent || brick;
    const deg = (props.degrees != null) ? props.degrees : 9;
    ...
    return e("svg", { viewBox: "20 28 320 290", className: "cbp-fig", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
      e("defs", null,
        e("linearGradient", { id: "cbpProtGrass", x1: "0", y1: "0", x2: "0", y2: "1" },
          e("stop", { offset: "0", stopColor: grassHi }), e("stop", { offset: "1", stopColor: grass }))
      ),
      // field group (rotated)
      e("g", { transform: "rotate(" + deg + " " + C[0] + " " + C[1] + ")" },
        e("path", { d: grassPath, fill: "url(#cbpProtGrass)", stroke: wallInk, strokeWidth: 1.6, strokeLinejoin: "round" }),
  ...
  window.CitizensProtractor = CitizensProtractor;
})();
