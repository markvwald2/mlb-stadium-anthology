/* target-protractor.jsx — Target Field "field orientation" symbol.
   A compact architectural protractor: a half-circle scale reads the field-axis
   bearing off true north, and the little ballpark is rotated to match
   (SE, 129deg). Subordinate to the page, per brief — an arc, ticks, LF/CF/RF
   chips and the SE / 129 cue, NOT a generic diamond icon. Twins palette: navy
   needle, red arrowhead, limestone-gold chips, field green.
   Props: lf, cf, rf, orientation, degrees. Exposes window.TargetProtractor. */
(function () {
  const e = React.createElement;

  const ink = "#232019", navy = "#002B5C", navyDeep = "#001B3D", red = "#C8102E",
        grass = "#5E7E54", grassHi = "#6E8B5E", clay = "#C0925A", clayEdge = "#A6793F",
        wallInk = "#384A33", paperHi = "#F4EDDC", rule = "#C6BAA0", ruleStrong = "#A99B7E",
        ink3 = "#8B8170", ink2 = "#564E3F";
  ...
  function TargetProtractor(props) {
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "26 36 308 286", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        ...
        e("g", { transform: "rotate(" + deg + " " + C[0] + " " + C[1] + ")" },
          e("path", { d: grassPath, fill: "url(#tfProtGrass)", stroke: wallInk, strokeWidth: 1.5, strokeLinejoin: "round" }),
  ...
  window.TargetProtractor = TargetProtractor;
})();
