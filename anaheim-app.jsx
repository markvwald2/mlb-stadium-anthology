/* anaheim-app.jsx — mount the Angel Stadium "Freeway Landmark" spread in the
   shared pan/zoom design canvas, with the press-ready single-page print path. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.AnaheimSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#151009" : "#EFE7D5";
  ...
  if (params.get("full")) {
    document.body.style.background = "#151009";
    ...
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        React.createElement(DCArtboard, {
          id: "angel-stadium-spread",
          label: "Angel Stadium of Anaheim \u2014 Big-A wayfinding survey, three architectural lives, scoreboard line score",
