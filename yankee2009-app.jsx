/* yankee2009-app.jsx — mount the Yankee Stadium (2009) "Section Through a
   Monument" spread in a pan/zoom design canvas, with the required vector-PDF
   print branch. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.YK2009Spread;
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        subtitle: "Section Through a Monument \u00b7 Memory as Infrastructure \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "yankee2009-section",
          label: "Section Through a Monument \u2014 daylight limestone hero + SURFACE | CORE section sheet",
