/* globe-life-app.jsx — mount the Globe Life Field spread in a pan/zoom design
   canvas (same wrapper as the other ballpark spreads). */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.GlobeLifeSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#0E1417" : "#E8ECEE";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        subtitle: "The Enormous Room \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "globe-life-spread",
          label: "Globe Life Field \u2014 The Enormous Room spread",
