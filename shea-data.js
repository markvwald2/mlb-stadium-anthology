...
window.SHEA = {
  ...
  stadium_context: [
    "Shea Stadium was built to restore National League baseball to New York after the departures of the Dodgers and Giants, but it also belonged to a broader 1960s faith in large public facilities. The Mets needed a permanent home after the Polo Grounds, and the city wanted a stadium that could serve more than baseball. The result was a colorful, modern, multipurpose venue tied to Queens, parkland, and the World\u2019s Fair-era image of metropolitan progress.",
