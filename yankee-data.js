...
window.YANKEE = {
  ...
  stadium_context: [
    "Yankee Stadium was built because the Yankees had become too large for borrowed space. After previous tenancies at Hilltop Park and the Polo Grounds, the franchise needed a home that could match the scale of its ambitions and the crowd it expected to command. The 1923 stadium in the Bronx was not merely a new ballpark; it was a declaration that baseball could occupy monumental civic architecture.",
    ...
    "The 2009 version of Yankee Stadium succeeded it not because its predecessor was lacking for meaning, but because meaning alone could not supply the premium inventory, media infrastructure, and controlled environment the modern Yankees franchise wanted. The old Yankee Stadium's demolition closed one of baseball's most famous and noteworthy architectural chapters, but it also revealed how memory of the franchise's aesthetic had become a design asset unto itself. The replacement carried forward the monumental vocabulary, proving that the 1923 building had become more than a venue: it had become a brand language powerful enough to be rebuilt across the street."
  ]
};
