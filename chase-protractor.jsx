/* chase-protractor.jsx — Chase Field "Field Plan" graphic, protractor study.
   A Chase-palette copy of the shared protractor diagram (cf. memorial-protractor)
   so the other stadiums stay untouched. A protractor scale reads the field-axis
   bearing off true north; the simple ballpark is rotated to match.
   Props: lf, cf, rf, orientation, degrees, accent. Exposes window.ChaseProtractor.
   Local data only. */
(function () {
  const e = React.createElement;

  // Chase palette (warm charcoal + Sedona red + Sonoran field green)
  const ink = "#211E1A", black = "#191510", sedona = "#A3392B", sedonaDeep = "#862C20";
  const grass = "#5F7E54", grassHi = "#6E8B5E", clay = "#C29760", clayEdge = "#A87C45", wallInk = "#3B4A36";
  const paperHi = "#F5EFE1", rule = "#CFC6B2", ruleStrong = "#B3A88F", ink3 = "#8B8273", ink2 = "#5A5249";
  ...
  function Chip(props) {
    ...
    const fill = tone === "accent" ? sedona : paperHi, stk = tone === "accent" ? sedonaDeep : rule, col = tone === "accent" ? paperHi : ink;
    return e("g", null,
  ...
  function ChaseProtractor(props) {
    const accent = props.accent || sedona;
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "20 28 320 290", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        e("defs", null,
          e("linearGradient", { id: "chfProtGrass", x1: "0", y1: "0", x2: "0", y2: "1" },
            e("stop", { offset: "0", stopColor: grassHi }), e("stop", { offset: "1", stopColor: grass }))
        ),
        // field group (rotated)
        e("g", { transform: "rotate(" + deg + " " + C[0] + " " + C[1] + ")" },
          e("path", { d: grassPath, fill: "url(#chfProtGrass)", stroke: wallInk, strokeWidth: 1.6, strokeLinejoin: "round" }),
        ...
        e(Chip, { x: bc.x, y: bc.y, text: deg + "\u00b0", size: 20, tone: "accent", padX: 7 }),
        // distance chips
  ...
  window.ChaseProtractor = ChaseProtractor;
})();
