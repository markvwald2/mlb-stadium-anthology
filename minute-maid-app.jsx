/* minute-maid-app.jsx — mount the Minute Maid Park spread in the shared
   pan/zoom design canvas, with the press-ready single-page print path. */
(function () {
  const { DesignCanvas, DCSection, DCArtboard } = window;
  const Spread = window.MinuteMaidSpread;
  ...
  if (params.get("print")) {
    ...
    const bg = side === "left" ? "#0C1622" : "#ECE3CF";
  ...
  function App() {
    return React.createElement(DesignCanvas, null,
      React.createElement(DCSection, {
        ...
        subtitle: "Platform 35: The Retractable Terminal \u00b7 Blurb 13 \u00d7 11 in \u00b7 25.50 \u00d7 10.88 in spread \u00b7 7650 \u00d7 3264 px @ 300 DPI (shown at 100 ppi)"
      },
        React.createElement(DCArtboard, {
          id: "minute-maid-spread",
          label: "Minute Maid Park \u2014 rail-terminal five-bay spread",
