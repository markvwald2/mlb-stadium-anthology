/* memorial-protractor.jsx — Memorial Stadium "Field Plan" graphic, protractor study.
   A Memorial-palette copy of the shared protractor diagram (cf. pnc-protractor) so the
   other stadiums stay untouched. A protractor scale reads the field-axis bearing off true
   north; the simple ballpark is rotated to match. Props: lf, cf, rf, orientation, degrees,
   accent. Exposes window.MemorialProtractor. Local data only. */
(function () {
  const e = React.createElement;

  // Memorial palette (warm charcoal + Orioles orange + ballpark green)
  const ink = "#1C1B19", black = "#1A1815", orange = "#B8461E", orangeDeep = "#8C3415";
  const grass = "#5C7E50", grassHi = "#6B8C5C", clay = "#BC9258", clayEdge = "#A87C45", wallInk = "#36492F";
  ...
  function MemorialProtractor(props) {
    ...
    return e("div", { className: "fd-wrap" },
      e("svg", { viewBox: "20 28 320 290", className: "fd-svg", role: "img", "aria-label": "Field dimensions plan, oriented " + orientation + " " + deg + " degrees" },
        e("defs", null,
          e("linearGradient", { id: "memProtGrass", x1: "0", y1: "0", x2: "0", y2: "1" },
            e("stop", { offset: "0", stopColor: grassHi }), e("stop", { offset: "1", stopColor: grass }))
        ),
        // field group (rotated)
        e("g", { transform: "rotate(" + deg + " " + C[0] + " " + C[1] + ")" },
          e("path", { d: grassPath, fill: "url(#memProtGrass)", stroke: wallInk, strokeWidth: 1.6, strokeLinejoin: "round" }),
        ...
        ticks, nums,
        e("text", { x: nlab[0], y: nlab[1] - 10, textAnchor: "middle", style: { fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: "13px", fill: ink, letterSpacing: ".04em" } }, "N"),
        ...
        e(Chip, { x: bc.x, y: bc.y, text: deg + "\u00b0", size: 18, tone: "accent", padX: 8 }),
        // distance chips
  ...
  window.MemorialProtractor = MemorialProtractor;
})();
