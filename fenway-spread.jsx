...
(function () {
  ...
  function VisitSection() {
    return e("div", { className: "fw-visit" },
      ...
      e("div", { className: "fw-games" },
        e("div", { className: "fw-morse", "aria-hidden": "true", dangerouslySetInnerHTML: { __html:
          '<svg viewBox="0 0 1200 300" xmlns="http://www.w3.org/2000/svg">' +
          '<path d="m82 167.4c-6.5 0-11.7-5.2-11.7-11.7 0-6.5 5.2-11.8 11.7-11.8 6.5 0 11.8 5.3 11.8 11.8 0 6.5-5.3 11.7-11.8 11.7z"/>' +
          '<path d="m233.2 146.9v16.5h-117.6v-16.5z"/>' +
          '<path d="m375.6 146.9v16.5h-117.7v-16.5z"/>' +
          '<path d="m771.5 143.9c6.5 0 11.8 5.3 11.8 11.8 0 6.5-5.3 11.7-11.8 11.7-6.5 0-11.8-5.2-11.8-11.7 0-6.5 5.3-11.8 11.8-11.8z"/>' +
          '<path d="m812.4 143.9c6.5 0 11.8 5.3 11.8 11.8 0 6.5-5.3 11.7-11.8 11.7-6.5 0-11.8-5.2-11.8-11.7 0-6.5 5.3-11.8 11.8-11.8z"/>' +
          '<path d="m621.8 164.5v-16.6h117.6v16.6z"/>' +
          '<path d="m1006 167.4c-6.5 0-11.8-5.2-11.8-11.7 0-6.5 5.3-11.8 11.8-11.8 6.5 0 11.8 5.3 11.8 11.8 0 6.5-5.3 11.7-11.8 11.7z"/>' +
          '<path d="m966.6 167.4c-6.5 0-11.8-5.2-11.8-11.7 0-6.5 5.3-11.8 11.8-11.8 6.5 0 11.8 5.3 11.8 11.8 0 6.5-5.3 11.7-11.8 11.7z"/>' +
          '<path d="m924.2 167.4c-6.5 0-11.7-5.2-11.7-11.7 0-6.5 5.2-11.8 11.7-11.8 6.5 0 11.8 5.3 11.8 11.8 0 6.5-5.3 11.7-11.8 11.7z"/>' +
          '<path d="m1157.2 146.8v16.6h-117.7v-16.6z"/>' +
          '<path d="m518 146.9v16.5h-117.7v-16.5z"/>' +
          '</svg>' } }),
        D.games.map(g => GameBlock(g)))
    );
  }
