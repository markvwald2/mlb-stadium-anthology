...
window.DODGER = {
  ...
  stadium_context: [
    "Dodger Stadium was built for a baseball franchise and an American city both trying to define themselves at major-league scale. After the Dodgers left Brooklyn for the west coast, the Los Angeles Memorial Coliseum could only be a temporary answer: huge, improvised, and not truly shaped for baseball. The permanent park in secluded Chavez Ravine provided the relocated club a home of its own and gave Los Angeles a stadium that matched the city\u2019s mid-century confidence in land, movement, and modern form.",
    "Its location was the central choice. Rather than imitate an older neighborhood ballpark, Dodger Stadium settled into a hilltop basin, surrounded by parkland and urban terrain, and organized around automobile arrival. That setting made the building feel both central and apart. It was close enough to the city to carry civic weight, but its experience was governed by grade changes, terraced parking, and the broad spatial logic of 60's Los Angeles. The ballpark did not ask fans to step off a dense street grid into baseball. It asked them to ascend into a designed landscape.",
