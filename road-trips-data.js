...
(function () {
  window.ROADTRIPS = {
    ...
    intro:
      ...
      "Major Leagues. Each trip was expertly planned around efficient routes, roadside hotels, and packed " +
      "schedules, with every game checking off another stadium on the poster that hung on our bedroom wall.",
