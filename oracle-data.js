...
window.ORACLE = {
  ...
  context: [
    ...
    "Scoreboard, seating, concession, center-field, and waterfront-edge upgrades have kept the park current without changing the basic relationship between field and bay. Oracle Park matters because it shows the retro-classic movement at its most site-dependent. It is not only a baseball replacement for a multipurpose predecessor; it is a park whose success depends on the precision of where it sits. In this anthology, it stands as one of the clearest examples of location becoming the stadium\u2019s central design material."
  ],
